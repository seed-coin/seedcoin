...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 6933 or testnet: 16933)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Seedcoin Wiki for SSL setup instructions)"),
